...
public class CompteurImplServiceLocator extends org.apache.axis.client.Service implements formation.CompteurImplService {
    ...
    public formation.CompteurImpl getCompteurImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public formation.CompteurImpl getCompteurImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            formation.CompteurImplPortBindingStub _stub = new formation.CompteurImplPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (formation.CompteurImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                formation.CompteurImplPortBindingStub _stub = new formation.CompteurImplPortBindingStub(new java.net.URL(CompteurImplPort_address), this);
                _stub.setPortName(getCompteurImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://formation/", "CompteurImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://formation/", "CompteurImplPort"));
        }
